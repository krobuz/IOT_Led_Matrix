...
byte letters[][8] = {
    ...
    0x7e,
    0x3c,
    0x18, // ❤   126  ~ 0x00, 0x00, 0x00, 0x28, 0x50, 0x00, 0x00, 0x00
};
...
int scroll_time = 100; // higher is scroll faster
...
void loop()
{
  ...
  if (mySerial.available() > 0)
  {
    ...
    Serial.println("Received from ESP: " + received); // Debug
...
{
  if (x < 0 || y < 0 || x >= NUM_MATRICES * MATRIX_COLS || y >= MATRIX_ROWS)
    return;
